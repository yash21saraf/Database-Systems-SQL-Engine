...
public class Main {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        File f = new File(CommonLib.TABLE_DIRECTORY + "GlobalIndex");


        if(f.exists() && !f.isDirectory()) {
            isPhase1 = false ;
            BufferedReader globalIndexReader = new BufferedReader(new FileReader(CommonLib.TABLE_DIRECTORY + "GlobalIndex"));
            String currentLine ;
            ...
            globalIndexWriter = new BufferedWriter(new FileWriter(CommonLib.TABLE_DIRECTORY + "GlobalIndex", true));
        }
// region queries
        String a[] = null;
        ...
        if(isPhase1){
            a = new String[]{a1, a2, a3, a4, a5, a6, a7, a8, q44};
        }else{
